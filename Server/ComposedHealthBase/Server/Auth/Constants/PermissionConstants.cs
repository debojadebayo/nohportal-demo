namespace ComposedHealthBase.Server.Auth.Constants
{
    /// <summary>
    ...
    public static class PermissionHelper
    {
        ...
        /// <param name="entityType">The entity type (e.g., "Schedule", "Employee")</param>
        /// <returns>Permission string (e.g., "CreateSchedule", "ViewEmployee")</returns>
