	...
	public sealed class CRMDbContext(DbContextOptions<CRMDbContext> options) : BaseDbContext<CRMDbContext>(options), IDbContext<CRMDbContext>
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Employee>().HasData(
				new Employee { Id = 1, FirstName = "Alice", LastName = "Smith", DOB = new DateTime(1990,1,1,0,0,0,DateTimeKind.Utc), Address1 = "1 Main St", Address2 = "Apt 1", Address3 = "", Postcode = "EMP1 1AA", Email = "alice.smith@example.com", Telephone = "07111 111111", CompanyName = "Acme Corp", JobRole = "Manager", Department = "HR", LineManager = "Bob Jones", IsActive = true, CreatedBy = 1, LastModifiedBy = 1, CreatedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc), ModifiedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc) },
				new Employee { Id = 2, FirstName = "Bob", LastName = "Jones", DOB = new DateTime(1985,2,2,0,0,0,DateTimeKind.Utc), Address1 = "2 Main St", Address2 = "Apt 2", Address3 = "", Postcode = "EMP2 2BB", Email = "bob.jones@example.com", Telephone = "07222 222222", CompanyName = "Beta Ltd", JobRole = "Engineer", Department = "IT", LineManager = "Carol White", IsActive = true, CreatedBy = 1, LastModifiedBy = 1, CreatedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc), ModifiedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc) },
				new Employee { Id = 3, FirstName = "Carol", LastName = "White", DOB = new DateTime(1992,3,3,0,0,0,DateTimeKind.Utc), Address1 = "3 Main St", Address2 = "Apt 3", Address3 = "", Postcode = "EMP3 3CC", Email = "carol.white@example.com", Telephone = "07333 333333", CompanyName = "Gamma Inc", JobRole = "Analyst", Department = "Finance", LineManager = "David Black", IsActive = true, CreatedBy = 1, LastModifiedBy = 1, CreatedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc), ModifiedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc) },
				new Employee { Id = 4, FirstName = "David", LastName = "Black", DOB = new DateTime(1988,4,4,0,0,0,DateTimeKind.Utc), Address1 = "4 Main St", Address2 = "Apt 4", Address3 = "", Postcode = "EMP4 4DD", Email = "david.black@example.com", Telephone = "07444 444444", CompanyName = "Acme Corp", JobRole = "Consultant", Department = "Consulting", LineManager = "Alice Smith", IsActive = true, CreatedBy = 1, LastModifiedBy = 1, CreatedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc), ModifiedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc) },
				new Employee { Id = 5, FirstName = "Eve", LastName = "Green", DOB = new DateTime(1995,5,5,0,0,0,DateTimeKind.Utc), Address1 = "5 Main St", Address2 = "Apt 5", Address3 = "", Postcode = "EMP5 5EE", Email = "eve.green@example.com", Telephone = "07555 555555", CompanyName = "Beta Ltd", JobRole = "Nurse", Department = "Medical", LineManager = "Bob Jones", IsActive = true, CreatedBy = 1, LastModifiedBy = 1, CreatedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc), ModifiedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc) },
				new Employee { Id = 6, FirstName = "Frank", LastName = "Blue", DOB = new DateTime(1983,6,6,0,0,0,DateTimeKind.Utc), Address1 = "6 Main St", Address2 = "Apt 6", Address3 = "", Postcode = "EMP6 6FF", Email = "frank.blue@example.com", Telephone = "07666 666666", CompanyName = "Gamma Inc", JobRole = "Technician", Department = "Support", LineManager = "Carol White", IsActive = true, CreatedBy = 1, LastModifiedBy = 1, CreatedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc), ModifiedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc) },
				new Employee { Id = 7, FirstName = "Grace", LastName = "Brown", DOB = new DateTime(1991,7,7,0,0,0,DateTimeKind.Utc), Address1 = "7 Main St", Address2 = "Apt 7", Address3 = "", Postcode = "EMP7 7GG", Email = "grace.brown@example.com", Telephone = "07777 777777", CompanyName = "Acme Corp", JobRole = "Advisor", Department = "Advisory", LineManager = "David Black", IsActive = true, CreatedBy = 1, LastModifiedBy = 1, CreatedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc), ModifiedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc) },
				new Employee { Id = 8, FirstName = "Henry", LastName = "Gray", DOB = new DateTime(1987,8,8,0,0,0,DateTimeKind.Utc), Address1 = "8 Main St", Address2 = "Apt 8", Address3 = "", Postcode = "EMP8 8HH", Email = "henry.gray@example.com", Telephone = "07888 888888", CompanyName = "Beta Ltd", JobRole = "Driver", Department = "Logistics", LineManager = "Eve Green", IsActive = true, CreatedBy = 1, LastModifiedBy = 1, CreatedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc), ModifiedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc) },
				new Employee { Id = 9, FirstName = "Ivy", LastName = "Violet", DOB = new DateTime(1993,9,9,0,0,0,DateTimeKind.Utc), Address1 = "9 Main St", Address2 = "Apt 9", Address3 = "", Postcode = "EMP9 9II", Email = "ivy.violet@example.com", Telephone = "07999 999999", CompanyName = "Gamma Inc", JobRole = "Receptionist", Department = "Admin", LineManager = "Frank Blue", IsActive = true, CreatedBy = 1, LastModifiedBy = 1, CreatedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc), ModifiedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc) },
				new Employee { Id = 10, FirstName = "Jack", LastName = "White", DOB = new DateTime(1989,10,10,0,0,0,DateTimeKind.Utc), Address1 = "10 Main St", Address2 = "Apt 10", Address3 = "", Postcode = "EMP10 0JJ", Email = "jack.white@example.com", Telephone = "07000 000000", CompanyName = "Acme Corp", JobRole = "Cleaner", Department = "Facilities", LineManager = "Grace Brown", IsActive = true, CreatedBy = 1, LastModifiedBy = 1, CreatedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc), ModifiedDate = new DateTime(2025, 4, 16, 17, 0, 0, DateTimeKind.Utc) }
			);
		}
	}
}