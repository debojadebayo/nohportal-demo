	...
	public sealed class CRMDbContext(DbContextOptions<CRMDbContext> options) : BaseDbContext<CRMDbContext>(options), IDbContext<CRMDbContext>
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Manager>().HasData(
				new Manager { Id = 1, KeycloakId = new Guid("55555555-5555-5555-5555-555555555555"), Name = "Thompson Smith", Email = "thompson.smith@example.com", Phone = "07111 111111", Department = "HR", CustomerId = 1 },
				new Manager { Id = 2, KeycloakId = new Guid("66666666-6666-6666-6666-666666666666"), Name = "Emily Johnson", Email = "emily.johnson@example.com", Phone = "07222 222222", Department = "Finance", CustomerId = 2 },
				new Manager { Id = 3, KeycloakId = new Guid("77777777-7777-7777-7777-777777777777"), Name = "Michael Brown", Email = "michael.brown@example.com", Phone = "07333 333333", Department = "IT", CustomerId = 3 }
			);
		}
	}
}