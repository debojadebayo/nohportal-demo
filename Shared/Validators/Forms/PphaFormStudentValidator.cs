...
{
    public class PphaFormStudentValidator : AbstractValidator<PphaFormStudentDto>
    {
        public PphaFormStudentValidator()
        {
        ...
        {
            var ctx = ValidationContext<PphaFormStudentDto>.CreateWithOptions((PphaFormStudentDto)model, x => x.IncludeProperties(property));
